  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-full border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        red: "bg-gradient-to-r from-[#B89542] to-[#D8BC72] text-[#FFFFFF] hover:from-[#9B7830] hover:to-[#C6A24A] shadow-[0_6px_20px_rgba(198,162,74,0.22)] hover:shadow-[0_12px_36px_rgba(198,162,74,0.28)] hover:-translate-y-0.5 btn-glow-emerald border border-[rgba(198,162,74,0.4)] focus-visible:ring-[#C6A24A]/40 focus-visible:ring-offset-2 focus-visible:ring-offset-[#F8F8F6]",
        "red-outline": "border-[#C6A24A] text-[#9B7830] hover:bg-[#C6A24A]/10 shadow-sm hover:shadow-[0_8px_24px_rgba(198,162,74,0.10)] hover:-translate-y-0.5 focus-visible:ring-[#C6A24A]/40 focus-visible:ring-offset-2 focus-visible:ring-offset-[#F8F8F6]",
        gold: "bg-gradient-to-r from-[#B89542] to-[#D8BC72] text-[#FFFFFF] hover:from-[#9B7830] hover:to-[#C6A24A] shadow-[0_6px_20px_rgba(198,162,74,0.22)] hover:shadow-[0_12px_36px_rgba(198,162,74,0.28)] hover:-translate-y-0.5 btn-glow-gold border border-[rgba(198,162,74,0.4)] focus-visible:ring-[#C6A24A]/40 focus-visible:ring-offset-2 focus-visible:ring-offset-[#F8F8F6]",
      ...
      size: {
        ...
        lg: "h-[3.25rem] gap-1.5 px-7 sm:h-12 sm:px-6 has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2",
        ...
        "icon-lg": "size-[3.25rem] sm:size-12",
      },
    },
    defaultVariants: {
      variant: "default",
