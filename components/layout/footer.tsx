          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a
                ...
                aria-label="LinkedIn"
                className="w-10 h-10 rounded-lg border border-[rgba(255,255,255,0.1)] flex items-center justify-center text-[rgba(255,255,255,0.4)] hover:text-[#C6A24A] hover:border-[#C6A24A]/40 transition-colors duration-300"
              >
