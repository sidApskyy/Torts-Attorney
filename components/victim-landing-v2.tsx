        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="max-w-2xl">
              ...
              >
                {['No upfront cost', 'Confidential', 'No pressure'].map((pill, i) => (
                  <span
                    key={i}
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/60 border border-[rgba(198,162,74,0.2)] text-sm text-[#4B5563]"
                  >
            ...
            >
              <div
                id="victim-form"
                className="bg-white/80 backdrop-blur-[24px] rounded-3xl p-6 md:p-8 border border-[rgba(198,162,74,0.15)] shadow-[0_12px_48px_rgba(32,33,36,0.08)]"
              >
                {!submitted ? (
                  <>
            ...
            >
              {campaigns.map((campaign) => (
                <motion.button
                  key={campaign.label}
                  variants={item}
                  whileHover={{ y: -6, boxShadow: '0 12px 32px rgba(198,162,74,0.12)' }}
                  onClick={() => handleCampaignClick(campaign.label)}
                  className="text-left content-card p-5 relative transition-colors"
                >
                  {campaign.hot && (
                    <span className="absolute top-4 right-4 inline-flex items-center gap-1 px-2 py-1 rounded-md bg-[#C6A24A]/10 text-[#C6A24A] text-xs font-bold uppercase tracking-wide">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {steps.map((step, i) => (
                ...
                >
                  <span className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-[#C6A24A]/10 text-[#C6A24A] mb-4">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            >
              {benefits.map((benefit) => {
                ...
                return (
                  <motion.div key={benefit.title} variants={item} className="content-card p-6 h-full">
                    <span className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-[#C6A24A]/10 text-[#C6A24A] mb-4">
