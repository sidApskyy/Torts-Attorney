...
export function LeadQualificationClient() {
  return (
    <main>
        <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Solutions', href: '/solutions' }, { label: 'Lead Qualification' }]} />
        <PageHero
          eyebrow="Solution"
          title={
          ...
          subtitle="Comprehensive lead qualification, screening, and dispositioning based on campaign criteria and firm requirements."
          cta={
            <Link href="/contact">
        ...
        <section className="bg-[#F5F7FA] py-16 md:py-20 lg:py-24 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              >
                Without systematic qualification, firms waste resources on unqualified leads. Effective qualification processes improve conversion and reduce acquisition costs.
              </motion.p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12 section-heading-glow">
                ...
                >
                  We implement systematic qualification processes to identify and prioritize qualified leads.
                </motion.p>
              </div>
        ...
        <section className="bg-[#F8F8F6] py-16 md:py-20 lg:py-24 relative overflow-hidden section-glow-gold">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                Let's discuss how we can optimize your lead qualification process.
              </motion.p>
