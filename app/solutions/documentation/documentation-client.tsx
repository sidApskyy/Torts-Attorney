...
export function DocumentationClient() {
  return (
    <main>
        <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Solutions', href: '/solutions' }, { label: 'Documentation & Compliance' }]} />
        <PageHero
          eyebrow="Solution"
          title={
          ...
          subtitle="Document collection, review, and management throughout the qualification process with compliance oversight."
          cta={
            <Link href="/contact">
        ...
        <section className="bg-[#F5F7FA] py-16 md:py-20 lg:py-24 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              >
                Incomplete documentation and compliance gaps create legal risk and delay case conversion. Systematic document management is essential for plaintiff acquisition.
              </motion.p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12 section-heading-glow">
                ...
                >
                  We implement systematic document collection and compliance oversight throughout the qualification process.
                </motion.p>
              </div>
        ...
        <section className="bg-[#F8F8F6] py-16 md:py-20 lg:py-24 relative overflow-hidden section-glow-gold">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                <GradientText animationSpeed={5}>
                  Optimize Your Documentation Process
                </GradientText>
              </motion.h2>
              ...
              >
                Let's discuss how we can optimize your documentation and compliance processes.
              </motion.p>
