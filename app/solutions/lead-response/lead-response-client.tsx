...
export function LeadResponseClient() {
  return (
    <main>
        <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Solutions', href: '/solutions' }, { label: 'Lead Response & Intake' }]} />
        <PageHero
          eyebrow="Solution"
          title={
          ...
          subtitle="Rapid lead response management, structured intake operations, and campaign-specific qualification workflows."
          cta={
            <Link href="/contact">
        ...
        <section className="bg-[#F5F7FA] py-16 md:py-20 lg:py-24 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              >
                Response delays and unstructured intake operations destroy lead value. Speed and structure are critical to converting leads into qualified cases.
              </motion.p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12 section-heading-glow">
                ...
                >
                  We implement rapid response systems and structured intake operations to maximize lead conversion.
                </motion.p>
              </div>
        ...
        <section className="bg-[#F8F8F6] py-16 md:py-20 lg:py-24 relative overflow-hidden section-glow-gold">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                <GradientText animationSpeed={5}>
                  Optimize Your Intake Operations
                </GradientText>
              </motion.h2>
              ...
              >
                Let's discuss how we can optimize your lead response and intake operations.
              </motion.p>
