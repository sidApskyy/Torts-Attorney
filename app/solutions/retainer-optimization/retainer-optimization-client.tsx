...
export function RetainerOptimizationClient() {
  return (
    <main>
      <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Solutions', href: '/solutions' }, { label: 'Retainer & Conversion Optimization' }]} />
      <PageHero
        eyebrow="Solution"
        title={
          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold leading-[0.95] tracking-[-0.02em] overflow-hidden">
            <GradientText animationSpeed={5}>
              Retainer & Conversion Optimization
            </GradientText>
          </h1>
        }
        subtitle="Retainer workflow support, document completion tracking, signature management, and conversion optimization."
        cta={
          <Link href="/contact">
        ...
        <section className="bg-[#F5F7FA] py-16 md:py-20 lg:py-24 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              >
                Retainer drop-off destroys acquisition ROI. Systematic retainer workflows and conversion optimization are critical to maximizing qualified case conversion.
              </motion.p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12 section-heading-glow">
                ...
                >
                  We implement systematic retainer workflows and conversion optimization to maximize qualified case conversion.
                </motion.p>
              </div>
        ...
        <section className="bg-[#F8F8F6] py-16 md:py-20 lg:py-24 relative overflow-hidden section-glow-gold">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                Let's discuss how we can optimize your retainer and conversion processes.
              </motion.p>
