...
export function ReportingClient() {
  return (
    <main>
      <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Solutions', href: '/solutions' }, { label: 'Reporting & Campaign Intelligence' }]} />
      <PageHero
        eyebrow="Solution"
        title={
        ...
        subtitle="Transparent performance reporting, metrics tracking, operational visibility, and campaign intelligence dashboards."
        cta={
          <Link href="/contact">
        ...
        <section className="bg-[#F5F7FA] py-16 md:py-20 lg:py-24 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              >
                Without transparent reporting and operational visibility, firms cannot optimize acquisition economics or identify performance issues. Campaign intelligence is essential for data-driven decision making.
              </motion.p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12 section-heading-glow">
                ...
                >
                  We implement comprehensive reporting and campaign intelligence systems for operational visibility.
                </motion.p>
              </div>
        ...
        <section className="bg-[#F8F8F6] py-16 md:py-20 lg:py-24 relative overflow-hidden section-glow-gold">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                Let's discuss how we can implement comprehensive reporting and campaign intelligence for your firm.
              </motion.p>
