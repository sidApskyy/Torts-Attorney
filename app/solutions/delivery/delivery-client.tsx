...
export function DeliveryClient() {
  return (
    <main>
        <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Solutions', href: '/solutions' }, { label: 'Delivery & Lead Distribution' }]} />
        <PageHero
          eyebrow="Solution"
          title={
            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold leading-[0.95] tracking-[-0.02em] overflow-hidden pb-2">
              <GradientText animationSpeed={5}>
                Delivery & Lead Distribution
              </GradientText>
            </h1>
          }
          subtitle="Qualified case delivery with complete documentation, attribution data, and seamless integration with your systems."
          cta={
            <Link href="/contact">
        ...
        <section className="bg-[#F5F7FA] py-16 md:py-20 lg:py-24 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              >
                Incomplete case delivery and poor integration create operational friction and delay case intake. Systematic delivery processes ensure qualified cases reach your team efficiently.
              </motion.p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12 section-heading-glow">
                ...
                >
                  We implement systematic case delivery processes with complete documentation and system integration.
                </motion.p>
              </div>
        ...
        <section className="bg-[#F8F8F6] py-16 md:py-20 lg:py-24 relative overflow-hidden section-glow-gold">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                Let's discuss how we can optimize your case delivery and integration processes.
              </motion.p>
