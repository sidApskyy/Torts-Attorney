...
export default function sitemap(): MetadataRoute.Sitemap {
  const routes: { path: string; priority: number; changeFrequency: 'weekly' | 'monthly' }[] = [
    ...
    { path: 'campaigns/depo-provera', priority: 0.8, changeFrequency: 'weekly' },
    { path: 'campaigns/ozempic-glp1', priority: 0.8, changeFrequency: 'weekly' },
    { path: 'campaigns/camp-lejeune', priority: 0.8, changeFrequency: 'weekly' },
    { path: 'campaigns/afff', priority: 0.8, changeFrequency: 'weekly' },
    { path: 'campaigns/roundup', priority: 0.8, changeFrequency: 'weekly' },
    { path: 'campaigns/talcum-powder', priority: 0.8, changeFrequency: 'weekly' },
    { path: 'campaigns/nec-formula', priority: 0.8, changeFrequency: 'weekly' },
    { path: 'campaigns/pfas', priority: 0.8, changeFrequency: 'weekly' },
    { path: 'campaigns/hernia-mesh', priority: 0.8, changeFrequency: 'weekly' },
