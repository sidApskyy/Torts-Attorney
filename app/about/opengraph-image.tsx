...
export const alt = 'About The Torts Attorney — Plaintiff Acquisition Intelligence'
    ...
    (
      ...
      >
        ...
        <div style={{ color: '#F8F8F6', fontSize: 56, fontWeight: 800, lineHeight: 1.1, fontFamily: 'serif', maxWidth: '900px', display: 'flex', flexDirection: 'column' }}>
          <span>Plaintiff Acquisition</span>
          <span style={{ color: '#C6A24A' }}>Intelligence.</span>
        </div>
        <div style={{ color: 'rgba(248, 248, 246, 0.6)', fontSize: 22, marginTop: '32px', maxWidth: '700px', lineHeight: 1.5 }}>
          We build and operate plaintiff acquisition systems for mass tort and personal injury firms.
        </div>
